...
{
    public class MaandAmbu: MaandPost
    {
        ...
        public MaandAmbu(int maxdag, int maxnacht, int aantalshifts, string planingNr, List<int> planningIndexen):base(planingNr, planningIndexen) 
        {
            MaxDag = maxdag;
            MaxNacht = maxnacht;
